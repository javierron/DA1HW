...
experiment MyExperiment type: gui {
    output {
		display MyDisplay camera_interaction:true camera_pos:{world.shape.width/2,world.shape.height*2,world.shape.width*2} 
		camera_look_pos:{world.shape.width/2,world.shape.height/2,0} 
		camera_up_vector:{0.0,-1.0,0.0}type:opengl{
			image '../images/grass.jpg' refresh: false;
